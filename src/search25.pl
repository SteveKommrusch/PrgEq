...
if ( ! -f $ARGV[2] || ! -d $ARGV[4] ) {
  print "Usage: search25.pl beam maxtok src model dir \n";
  print "    Open source file and search 25 steps to see if model can prove\n";
...
for (my $axsteps=1; $axsteps <= 25; $axsteps++) {
